...
TEST(math_color_test, getHSL) {
  ...
  EXPECT_EQ( hsl.h, 0.5 );
  EXPECT_EQ( hsl.s, 1.0 );
  EXPECT_EQ( (Math::round(hsl.l*100)/100), 0.75 );
}
...
TEST(math_color_test, setHSL) {
  ...
  EXPECT_EQ( hsl.h, 0.75 );
  EXPECT_EQ( hsl.s, 1.00 );
  EXPECT_EQ( hsl.l, 0.25 );
}