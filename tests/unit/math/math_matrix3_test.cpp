...
TEST(math_matrix3_test, constructor) {
	...
	EXPECT_TRUE( b.elements[1] == 3 );
	EXPECT_TRUE( b.elements[2] == 6 );
	EXPECT_TRUE( b.elements[3] == 1 );
	EXPECT_TRUE( b.elements[4] == 4 );
	EXPECT_TRUE( b.elements[5] == 7 );
	EXPECT_TRUE( b.elements[6] == 2 );
	EXPECT_TRUE( b.elements[7] == 5 );
	EXPECT_TRUE( b.elements[8] == 8 );
...
TEST(math_matrix3_test, multiplyScalar) {
	...
	EXPECT_TRUE( b.elements[1] == 3*2 );
	EXPECT_TRUE( b.elements[2] == 6*2 );
	EXPECT_TRUE( b.elements[3] == 1*2 );
	EXPECT_TRUE( b.elements[4] == 4*2 );
	EXPECT_TRUE( b.elements[5] == 7*2 );
	EXPECT_TRUE( b.elements[6] == 2*2 );
	EXPECT_TRUE( b.elements[7] == 5*2 );
	EXPECT_TRUE( b.elements[8] == 8*2 );
}
...
TEST(math_matrix3_test, transpose) {
	...
	EXPECT_TRUE( matrixEquals3( a, b, 0.0001 ) );

	b = Matrix3( 0, 1, 2, 3, 4, 5, 6, 7, 8 );
	auto c = b.clone().transpose();
	EXPECT_TRUE( ! matrixEquals3( b, c, 0.0001 ) );
	c.transpose();
	EXPECT_TRUE( matrixEquals3( b, c, 0.0001 ) );
}
