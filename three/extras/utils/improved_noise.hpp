...
public:
    float noise(float x, float y, float z)
    {
        ...
        auto floorX = Math::floor(x),
             floorY = Math::floor(y),
             floorZ = Math::floor(z);

        auto X = ((int)floorX & 255),
             Y = ((int)floorY & 255),
             Z = ((int)floorZ & 255);
        ...
        return lerp(w, lerp(v, lerp(u, grad(p[AA], x, y, z), grad(p[BA], xMinus1, y, z)), lerp(u, grad(p[AB], x, yMinus1, z), grad(p[BB], xMinus1, yMinus1, z))),
                    lerp(v, lerp(u, grad(p[AA + 1], x, y, zMinus1), grad(p[BA + 1], xMinus1, y, z - 1)),
