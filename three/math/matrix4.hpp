...
public:
  ...
  THREE_DECL Matrix4& multiplyToArray( const Matrix4& a, const Matrix4& b, const Matrix4& r );
  THREE_DECL Matrix4& multiplyScalar( float s );
  THREE_DECL Vector3& multiplyVector3( const Vector3& vector );
  THREE_DECL Vector4& multiplyVector4( const Vector4& vector );
  THREE_DECL std::vector<float>& multiplyVector3Array( const std::vector<float>& a);
  ...
  THREE_DECL Matrix4& getInverse( const Matrix4& m, bool throwOnInvertible );
  ...
  THREE_DECL Matrix4& decompose( Vector3& position, const Quaternion& quaternion, Vector3& scale );
