...
DECLARE_UNIFORM_KEY(boneTextureWidth)
DECLARE_UNIFORM_KEY(boneTextureHeight)
...
DECLARE_UNIFORM_KEY(normalMap)
DECLARE_UNIFORM_KEY(normalScale)
...
DECLARE_UNIFORM_KEY(spotLightAngleCos)
...
DECLARE_UNIFORM_KEY(hemisphereLightDirection)
...
DECLARE_UNIFORM_KEY(dashSize)
DECLARE_UNIFORM_KEY(totalSize)
