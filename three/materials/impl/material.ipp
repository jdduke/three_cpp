...
#define PARAM_LOAD(PARAM_NAME)                                          \
    if (keys.count(#PARAM_NAME) > 0 || defaults.count(#PARAM_NAME) > 0) \
    load(parameters.contents, #PARAM_NAME, PARAM_NAME)
