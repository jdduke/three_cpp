...
{
    return "#if defined( USE_ENVMAP ) && ! defined( USE_BUMPMAP )\n"
           "varying vec3 vReflect;\n"
           "uniform float refractionRatio;\n"
           "uniform bool useRefract;\n"
           "#endif\n";
...
{
    return "#if defined( USE_MAP ) || defined( USE_BUMPMAP ) || defined( USE_SPECULARMAP )\n"
           "varying vec2 vUv;\n"
...
namespace detail {
    ...
    static Shader normalCreate()
    {
        ...
        const char* vertexShader = "varying vec3 vNormal;\n"
                                   "void main() {\n"
    ...
    static Shader basicCreate()
    {
        ...
        fss << "uniform vec3 diffuse;" << std::endl
    ...
    static Shader lambertCreate()
    {
        ...
        std::stringstream vss;
        vss << "varying vec3 vLightFront;" << std::endl
    ...
    static Shader particleBasicCreate()
    {
        ...
        std::stringstream vss;
        vss << "uniform float size;" << std::endl
        ...
        std::stringstream fss;
        fss << "uniform vec3 psColor;" << std::endl
            << "uniform float opacity;" << std::endl
            <<
