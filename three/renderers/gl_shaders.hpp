...
class ShaderChunk {
	...
	const char* envmap_pars_fragment() {
		return
		"#ifdef USE_ENVMAP"
	...
	const char* map_particle_fragment() {
		return
		"#ifdef USE_MAP"
	...
	const char* lightmap_pars_fragment() {
		return
		"#ifdef USE_LIGHTMAP"
			"varying vec2 vUv2;"
	...
	const char* lightmap_pars_vertex() {
		return
		"#ifdef USE_LIGHTMAP"
			"varying vec2 vUv2;"
		"#endif";
	...
	const char* bumpmap_pars_fragment() {
	...
	const char* lights_lambert_pars_vertex() {
		return
	...
	const char* lights_lambert_vertex() {
		return
	...
	const char* lights_phong_pars_vertex() {
	...
	const char* lights_phong_vertex() {
	...
	const char* lights_phong_pars_fragment() {
	...
	const char* color_pars_fragment() {
	...
	const char* skinning_pars_vertex() {
	...
	const char* morphtarget_pars_vertex() {
	...
	const char* shadowmap_pars_fragment() {
	...
	const char* shadowmap_pars_vertex() {
	...
	const char* linear_to_gamma_fragment() {
